...
class PurchaseCoreModel extends ValueModel<List<PurchaseProduct>> {
  PurchaseCoreModel() : super([]);
  ...
  Future<PurchaseCoreModel> initialize(
      ...
      Future<void> Function(PurchaseDetails purchase, PurchaseProduct product,
              PurchaseCoreModel core)?
          onDeliver,
      Future<void> Function(PurchaseCoreModel core)? onCheckSubscription,
  ...
  ///
  /// [timeout]: Timeout settings.
  Future<PurchaseCoreModel> restore(
  ...
  /// [timeout]: Timeout settings.
  Future<PurchaseCoreModel> consume(
  ...
  /// [timeout]: Timeout settings.
  Future<PurchaseCoreModel> purchase(String id,
  ...
  ///
  /// [id]: Product Id.
  PurchaseProduct? getProduct(String id) {
    assert(isInitialized,
        "It has not been initialized. First, execute [initialize] to initialize.");
    return findById(id);
  }
  ...
  late final Future<bool> Function(PurchaseDetails purchase,
      PurchaseProduct product, PurchaseCoreModel core)? _onVerify;
  late final Future Function(PurchaseDetails purchase, PurchaseProduct product,
      PurchaseCoreModel core)? _onDeliver;
  late final Future Function(PurchaseDetails purchase, PurchaseProduct product,
      PurchaseCoreModel core)? _onSubscribe;
  late final Future Function(PurchaseDetails purchase, PurchaseProduct product,
      PurchaseCoreModel core)? _onUnlock;
  late final Future Function(PurchaseCoreModel core)? _onCheckSubscription;
  ...
  PurchaseProduct? findById(String id) {
    ...
    return value.firstWhereOrNull((product) => product.id == id);
  }
  ...
  Future getAuthorizationCode() async {
    if (!Config.isAndroid) {
      return;
    }
